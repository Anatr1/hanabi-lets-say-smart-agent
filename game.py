...
class Game(object):
    ...
    def displayStatus(self):
        ...
        print("Hints Tokens: " + str(self.__noteTokens))
        print("Storm Tokens: " + str(self.__stormTokens))

    def printTableCards(self):
        print("Red: "    + self.getMaxCardColor("red"))
        print("Green: "  + self.getMaxCardColor("green"))
        print("Blue: "   + self.getMaxCardColor("blue"))
        print("Yellow: " + self.getMaxCardColor("yellow"))
        print("White: "  + self.getMaxCardColor("white"))

    def getMaxCardColor(self, color):
        cards = self.__tableCards[color]
        c_max = 0
        for c in cards:
            if c.value > c_max:
                c_max = c.value
